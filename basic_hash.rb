...
def frequent_word(string)
  ...
  while index < string.length
    if word_count[string[index]]
      word_count[string[index]] += 1
    else
      word_count[string[index]] = 1
    end
    index += 1
...
p frequent_word(["Dewey", "Truman", "Martha", "Dewey", "Dewey", "Truman", "Truman", "Dewey", "Truman", "Truman", "Dewey", "Dewey"])
...
def dna_to_rna (string)
  ...
  string.chars.each do |change|
    converted << pairs[change]
  end
